--!jinja
---------------------------------------------------------------------
-- Script   : 60_FrameworkEmailSeed_DML_v1.0.sql
-- Purpose  : Seed FRAMEWORK.EMAIL_BODY_DISPLAY_CONFIG. Direct mirror of
--            Validated_Reads_Load_Email_Config_DML.sql from prod, scaled
--            down to two demo processes.
